...
showLife() {
  push();
  image(lifeImage, player.positionX - 260, height - player.positionY - 100, 20, 20);
  fill("white");
  rect(player.positionX - 210, height - player.positionY - 100, 185, 20);
  fill("#f50057");
  rect(player.positionX - 210, height - player.positionY - 100, player.life, 20);
  noStroke();
  pop();
}
showFuel(){
  push();
  image(fuelImage, player.positionX - 260, height - player.positionY - 40, 20, 20);
  fill("brown");
  rect( player.positionX - 210, height - player.positionY - 40, 185, 20);
  fill("#929605");
  rect(player.positionX - 210, height - player.positionY - 40, player.fuel, 20);
  noStroke();
  pop();
}
showLeaderboard() {
